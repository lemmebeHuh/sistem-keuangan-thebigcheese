                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-6 pt-4">
                        ...
                        <table class="min-w-full mt-2">
                            ...
                            @empty
                                {{-- Jangan tampilkan apa-apa jika tidak ada, agar tidak duplikat dengan pesan "tidak ada pengeluaran" --}}
                            @endforelse

                            {{-- Pengeluaran dari Gaji --}}
                            @if($totalPayroll > 0)
                            <tr>
                            ...
                            {{-- Kondisi jika tidak ada pengeluaran sama sekali --}}
                            @if($totalExpense == 0)
